<template>
    <!-- Introduction -->
    <section class="mb-8 py-20 text-white text-center relative bg-img">
        <div
    ...
    <section class="container mx-auto">
        ...
        >
            ...
            <!-- Playlist -->
            <ol id="playlist">
                <li v-for="song in songs" class="flex justify-between items-center p-3 pl-6 cursor-pointer transition duration-300 hover:bg-gray-50">
                    <div>
